...
public class MasterProjectTenantDatabaseMigrationHandler :
    ...
    ITransientDependency
{
    ...
    private readonly ILogger<MasterProjectTenantDatabaseMigrationHandler> _logger;

    public MasterProjectTenantDatabaseMigrationHandler(
        MasterProjectEFCoreDbSchemaMigrator dbSchemaMigrator,
        ICurrentTenant currentTenant,
        IUnitOfWorkManager unitOfWorkManager,
        IDataSeeder dataSeeder,
        ITenantStore tenantStore,
        ILogger<MasterProjectTenantDatabaseMigrationHandler> logger)
    {
