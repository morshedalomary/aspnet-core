...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 83e0b85a-7e5a-45db-a316-9d5b64e72e14
```

> `83e0b85a-7e5a-45db-a316-9d5b64e72e14` is the password of the certificate, you can change it to any password you want.
...
The application needs to a database. Run the following command in the `MasterProject` directory to migrate the database and seed the initial data:
