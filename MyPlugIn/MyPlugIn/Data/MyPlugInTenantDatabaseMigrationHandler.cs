...
public class MyPlugInTenantDatabaseMigrationHandler :
    ...
    ITransientDependency
{
    ...
    private readonly ILogger<MyPlugInTenantDatabaseMigrationHandler> _logger;

    public MyPlugInTenantDatabaseMigrationHandler(
        MyPlugInEFCoreDbSchemaMigrator dbSchemaMigrator,
        ICurrentTenant currentTenant,
        IUnitOfWorkManager unitOfWorkManager,
        IDataSeeder dataSeeder,
        ITenantStore tenantStore,
        ILogger<MyPlugInTenantDatabaseMigrationHandler> logger)
    {
